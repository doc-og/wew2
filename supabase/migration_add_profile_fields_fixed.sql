-- Migration: Add profile fields and set up guardian relationships (CORRECTED)
...
BEGIN
    ...
    -- Add guardian roles (if roles table exists - will skip if not)
    BEGIN
        -- seano is Guardian Owner for roseo
        ...
        RAISE NOTICE 'Guardian roles added successfully';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE NOTICE 'Roles table does not exist, skipping role assignments';
    END;
